...
public class pagerTransition extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        /*rootView.getViewTreeObserver().addOnGlobalLayoutListener(new ViewTreeObserver.OnGlobalLayoutListener() {
            ...
            public void onGlobalLayout() {
                ...
                filterList.getLocationInWindow(imagelocation);
                final float imageX = imagelocation[0] + filterList.getMeasuredWidth() / 2f;
                final float imageY = imagelocation[1] + filterList.getMeasuredHeight() / 2f;
    ...
    public void setShowcaseView() {
        ...
        boolean isFirstRun = wmbPreference.getBoolean("SHOW21", true);
                    ...
                    Spotlight.with((Activity) getContext())
                            ...
                            .setOnSpotlightStateListener(new OnSpotlightStateChangedListener() {
                                ...
                                public void onEnded() {
                                    ...
                                    editor.putBoolean("SHOW21", false).apply();
                                    Toast.makeText(getContext(), "spotlight is ended", Toast.LENGTH_SHORT).show();
                                }
                            })
                            .start();
