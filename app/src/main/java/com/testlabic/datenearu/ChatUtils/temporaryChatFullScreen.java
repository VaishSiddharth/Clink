...
public class temporaryChatFullScreen extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        imageView.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Toast.makeText(temporaryChatFullScreen.this, "Under Development", Toast.LENGTH_SHORT).show();
            }
        });
    ...
    private void DisplayHelpDialog() {
        ...
        btn1.setBackground(ContextCompat.getDrawable(temporaryChatFullScreen.this, R.drawable.button_4_dialogue));
